...
function getOperationButtonsHTML(task) {
    ...
    const workbenchHTML = (typeof getWorkbenchInlineHTML === 'function')
        ? getWorkbenchInlineHTML(task)
        : ((typeof getSkillInlineActionHTML === 'function') ? getSkillInlineActionHTML(task) : '');

    return `<div class="operation-buttons-main">${buttonsHTML}${workbenchHTML}</div>`;
}
